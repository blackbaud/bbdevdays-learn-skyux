...
describe('PersistenceService', () => {
  ...
  it('should initialize with data from storage', async () => {
    const sessionStorage = new MockStorageService();
    TestBed.overrideProvider(SESSION_STORAGE, { useValue: sessionStorage });
  ...
  it('should access session storage', () => {
    expect(TestBed.inject(SESSION_STORAGE)).toBeTruthy();
  });
});

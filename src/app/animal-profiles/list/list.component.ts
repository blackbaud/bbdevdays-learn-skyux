...
export class ListComponent implements OnInit {
  ...
  protected readonly avatarTemplate =
    viewChild<TemplateRef<unknown>>('avatarTemplate');
  protected readonly flagTemplate =
    viewChild<TemplateRef<unknown>>('flagTemplate');
  protected readonly linkTemplate =
    viewChild<TemplateRef<unknown>>('linkTemplate');

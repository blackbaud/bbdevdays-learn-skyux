...
<a href="./public/images/data-service.png"><img src="./public/images/data-service.png" alt="Diagram of a data service initialized from a static file and saved to browser local storage." width="700" style="max-width: 100%" /></a>
